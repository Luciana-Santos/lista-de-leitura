...
function initEvents() {
  ...
  var books = _Store__WEBPACK_IMPORTED_MODULE_0__["default"].getBooks(); // renderiza capa na área de input
    ...
    if (dateContainer) {
      modalDatePrevision.addEventListener('change', function (_ref5) {
        ...
        if (target.value > totalPages.innerText || target.value <= 0) {
          ...
          var percentage = _UI__WEBPACK_IMPORTED_MODULE_1__["default"].getPregressPerc(target.value, totalPages.innerText);
  ...
  modalContainer.addEventListener('click', function (_ref6) {
    ...
    if (target.classList.contains('confirm')) {
      ...
      books.forEach(function (book) {
        ...
        book.percentage = _UI__WEBPACK_IMPORTED_MODULE_1__["default"].getPregressPerc(book.currPag, book.pagesTotal);
        ...
        if (+idTarget === book.id) {
          ...
          (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.bookCompleted)(book);
        }
      });
    }
  });
